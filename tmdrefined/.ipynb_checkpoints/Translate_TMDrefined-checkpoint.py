...
def aa_numeric_by_scale(feature_df: pd.DataFrame, label_df: pd.DataFrame, scale_df_filter: list = None,
    ...
    # normalized scales
    path_to_scales_df = f"{path.split("tmdrefined")[0]}{sep}_scales{sep}scales.xlsx"
...
if __name__ == "__main__":
    ...
    label_df_test = (pd.read_excel(f"{path.split("tmdrefined")[0]}example{sep}am_label_single_stop_pos_TMD_thresh=3.xlsx")
                     .set_index("ID"))
