...
class ForestTMDrefind:
    ...
    def feature_importance(self):
        ...
        path_file, path_module, sep = find_folderpath()
        path_to_scales_df = f"{path_module.split("tmdrefined")[0]}{sep}_scales{sep}scales_cat.xlsx"
...
if __name__ == "__main__":
    ...
    label_df_test = (pd.read_excel(f"{path_module.split("tmdrefined")[0]}example{sep}am_label_single_stop_pos_TMD_thresh=3.xlsx")
                     .set_index("ID"))
